	...
	create: function create(_ref) {
		...
		function wrapActionCreator(actionCreator, name) {
			return function getAndDispatchActions(payload) {
				...
				(0, _invariant2['default'])(typeof result.subscribe === 'function', 'Actions creators must return Rx.Observables. You returned: $s', result);
